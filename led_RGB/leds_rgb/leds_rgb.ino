...
SoftwareSerial esp8266(3,2); //Pin 2 & 3 of Arduino as RX and TX. Connect TX and RX of ESP8266 respectively.
#define DEBUG true
#define led_pin1 11 //LED is connected to Pin 13 of Arduino
#define led_pin2 10 //LED Pin 12
#define led_pin3 9 //LED Pin 11
        ...
        if (esp8266.find("+IPD,"))
          {
            ...
            delay(100);
              ...
              else if (command2 == "ON4") 
                    {
                      rgb_color(150,165,0);
                      Serial.println("Turn ON");
                    }
                    
              else if (command2 == "ON5") 
                    {
                      rgb_color(100,0,165);
                      Serial.println("Turn ON");
                    }
                    
              else if (command2 == "ON6") 
                    {
                      rgb_color(255,0,128);
                      Serial.println("Turn ON");
                    }
...
String esp8266Serial(String command, const int timeout, boolean debug)
  ...
  void rgb_color(int red, int green, int blue){
    analogWrite(led_pin1, red);
    analogWrite(led_pin2, green);
    analogWrite(led_pin3, blue);
  }
